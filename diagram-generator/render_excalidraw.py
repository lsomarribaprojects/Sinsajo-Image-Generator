...
Built by Sinsajo Creators — https://www.sinsajocreators.com
...
def render(
    ...
    template_path = Path(__file__).parent / "references" / "render_template.html"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Render Excalidraw JSON to PNG — by Sinsajo Creators")
